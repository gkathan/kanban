...
server.post({path : PATH_LANES, version : '0.0.1'} , save);
...
var PATH_ORG14APR = '/org2014april';
server.get({path : PATH_ORG14APR , version : '0.0.1'} , findAllByName);

var PATH_ORG13 = '/org2013april';
server.get({path : PATH_ORG13 , version : '0.0.1'} , findAllByName);


var PATH_ORG12 = '/org2012april';
server.get({path : PATH_ORG12 , version : '0.0.1'} , findAllByName);
